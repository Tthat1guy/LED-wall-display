...
#define Strip3Length xx //length in pixels of strip 2
...
Adafruit_NeoPixel strip3(Strip2Length, Strip2Pin, NEO_GRB + NEO_KHZ800);
...
strip3.fill(color,0,Strip3Length);
...
strip1.fill(color,0,Strip1Length);//fills the strip with color
strip2.fill(color,0,Strip2Length);
strip3.fill(color,0,Strip2Length);
